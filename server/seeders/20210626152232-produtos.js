  ...
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert("Produtos", [
      ...
      },
      {
        ...
        detalhes:
          "A POTÊNCIA DA 10ª GERAÇÃO <br />Os processadores Intel Core da 10ª geração oferecem atualizações de desempenho incríveis, para melhorar a produtividade e proporcionar entretenimento surpreendente, com clocks poderosos, otimização inteligente de sistema e muito mais.  <br /> <br /> PRODUTIVIDADE ACELERADA  <br /> Recursos de desempenho inteligente integrados aprendem adaptam-se ao que você faz, direcionando potência dinamicamente para onde ela é mais necessária. Os processadores Intel® Core™ da 10ª geração fornecem a responsividade para fazer mais. <br />  <br />ENTRETENIMENTO PREMIUM   <br />Uma nova arquitetura de gráficos oferece suporte a experiências visuais ultravívidas, como vídeo em HDR 4K e jogos a 1080p. Os processadores Intel® Core™ da 10ª geração permitem experiências de entretenimento nunca vistas. <br /> <br />JOGOS SÉRIOS <br /> Aproveite jogos incríveis com alto FPS, até mesmo enquanto realiza streaming e gravação. Os processadores Intel® Core™ da 10ª geração executam nas plataformas definitivas de jogos. <br /> <br />Socket: LGA 1200 <br />Frequência Base: 2.90 GHz  <br />Frequência Turbo: Até 4.30 GHz  <br /> Número Núcleos: 6   <br />Número Threads: 12   <br />Cache: 12 MB <br />Litografia: 14 nm<br />TDP: 65 W",
        stock: "1",
        marca: "Intel Core",
      },
      {
        ...
        detalhes:
          "PROJETADO PARA OS MELHORES GAMERS DO MUNDO  <br />Usufrua de desempenho excepcional, entretenimento imersivo e conveniência simples com os processadores Intel Core da 9ª Geração. O processador i9 9900KF amplia todos os recursos que os utilizadores adoram nos CPUs da geração anterior com inovações ainda mais avançadas que oferecem novos níveis de desempenho que o colocam no seu computador em vários formatos. O i9 9900KF apresenta todas as mais recentes tecnologias da Intel para permitir que você tenha a melhor experiência em computação, e este CPU em particular é desbloqueado, permitindo que você faça overclock para capacidade adicional em jogos ou de produção.  <br /> <br /> JOGUE, FAÇA STREAM E GRAVE SEM COMPROMISSO.  <br />Os processadores Intel Core da 9ª Geração redefinem o desempenho do PC desktop convencional. O i9 9900KF possui oito núcleos para maior capacidade de processamento e multitarefa sem esforço. O recurso Desbloqueado neste chip permite overclocking, permitindo ajustar o desempenho. A tecnologia Intel Turbo Boost 2.0 também aumentou a frequência turbo máxima de 5,0 GHz e até 16 MB de memória cache para uma jogabilidade e resposta ultra-suaves. O processador da 9ª geração i9 permite-lhe desfrutar de excelentes jogos e experiências de VR.    <br />     <br />FAÇA STREAM E JOGUE EM 4K UHD    <br /> Os computadores desktop baseados nos processadores Intel Core da 9ª Geração integram tecnologias avançadas que trazem conteúdo premium de alta qualidade para o seu desktop para oferecer streaming suave de entretenimento 4K UHD premium para o seu PC. <br />   <br />   <br />  <br />Socket: LGA 1151  <br />Frequência Base: 3.60 GHz  <br />Frequência Turbo: Até 5.00 GHz <br />Número Núcleos: 8  <br />Número Threads: 16  <br /> Cache: 16 MB  <br />Litografia: 14 nm<br />TDP: 95 W",
        stock: "1",
        marca: "Intel Core",
      },
      {
